...
import { CATEGORIAS_CASA, actualizarItemListaComprasCasa, agregarItemListaComprasCasa } from "@/lib/data/casa";

export default function ItemListaCompraCasaFormModal({ item, ubicaciones, ubicacionIdPredeterminada, onClose, onGuardado }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (item) await actualizarItemListaComprasCasa(item.id, datos);
      else await agregarItemListaComprasCasa(datos);
      onGuardado();
    } catch (err) {
