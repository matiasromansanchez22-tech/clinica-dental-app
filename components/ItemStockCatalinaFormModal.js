...
import { CATEGORIAS_CATALINA, actualizarItemStockCatalina, crearItemStockCatalina } from "@/lib/data/catalina";

export default function ItemStockCatalinaFormModal({ item, categoriaPredeterminada, onClose, onGuardado }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (item) await actualizarItemStockCatalina(item.id, datos);
      else await crearItemStockCatalina(datos);
      onGuardado();
    } catch (err) {
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          <label className="flex flex-col gap-1 text-sm text-gray-700">
            ...
            <input
              ...
              placeholder="Ej. Potito de manzana, Fórmula etapa 2"
