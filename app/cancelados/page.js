...
import { obtenerTurnosCanceladosGeneral } from "@/lib/data/turnosCancelados";
...
export default function CanceladosPage() {
  ...
  useEffect(() => {
    ...
    setCargando(true);
    obtenerTurnosCanceladosGeneral(anio, mes)
      .then(setTurnos)
  ...
  return (
    <main className="mx-auto max-w-4xl p-6">
      <h1 className="text-2xl font-bold text-gray-900">Turnos cancelados</h1>
