...
export default function VerAgendaDelDiaPage() {
  ...
  return (
    <main className="mx-auto max-w-6xl p-6">
      <h1 className="text-2xl font-bold text-gray-900">Ver Agenda del Día (solo lectura)</h1>
      ...
      <div className="mt-4">
        {cargando ? (
          ...
          <AgendaGrid turnos={turnos} bloques={bloques} onTurnoClick={setTurnoElegido} />
        )}
      </div>
