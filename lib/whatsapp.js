...
export function mensajeSeguimientoPresupuesto(nombrePaciente) {
  return `¡Hola ${nombrePaciente}! Te escribimos desde Clínica Dental Marianela Ramírez. Vimos que tenés un presupuesto armado con nosotros y queríamos saber si te quedó alguna duda o si querés que coordinemos un turno para arrancar. ¡Quedamos a tu disposición!`;
}
