...
// Lunes de la semana que contiene fechaISO (semana de lunes a domingo).
export function inicioDeSemana(fechaISO) {
  const diaSemana = diaSemanaDeFecha(fechaISO); // 0=Domingo..6=Sábado
  const diasDesdeElLunes = diaSemana === 0 ? 6 : diaSemana - 1;
  return sumarDias(fechaISO, -diasDesdeElLunes);
}
