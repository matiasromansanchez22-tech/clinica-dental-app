...
// turnos_general marca "atendido" con la columna asistencia = 'Asistió';
// turnos_ortodoncia no tiene esa columna, usa presencia = 'Finalizado'.
...
export async function obtenerActividadDelDia(fecha) {
  ...
  const [
    ...
    contarTurnosAtendidos("turnos_ortodoncia", fecha, "presencia", "Finalizado"),
