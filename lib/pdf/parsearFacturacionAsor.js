...
//
// pdfjs-dist espera algunas APIs del navegador (DOMMatrix) que no existen en
// el servidor (Node no tiene DOM). Como acá solo leemos texto y coordenadas
// — no dibujamos nada — alcanza con un reemplazo mínimo antes de importarla.
